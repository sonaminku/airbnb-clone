...
const PhotosUploader = ({ addedPhotos, onChange }) => {
  ...
  return (
    <div>
      ...
      <div className="mt-2 -mb-1 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <label className="border h-32 flex cursor-pointer items-center gap-1 justify-center bg-transparent rounded-2xl p-2 text-2xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
